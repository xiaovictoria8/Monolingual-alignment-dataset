...
Outputs the top n sentence pairs from the input, as sorted by Jaccard distance.
            ...
            for i in range(8, len(row)):
                for j in range(i+1, len(row)):
                    ...
                    and row[j][len(row[j]) - 1] in "!\".?"):
                        ...
                        pair = [jd, pair_id, src, tgt, src_lemma, tgt_lemma,
                                row[2], row[3], row[5], ld]
